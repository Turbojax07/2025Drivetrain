...
public class RobotContainer {
    ...
    public RobotContainer() {
        if (RobotBase.isReal()) {
            drive = new Drive(new GyroIOPigeon2(), new ModuleIOSpark(0), new ModuleIOSpark(1), new ModuleIOSpark(2), new ModuleIOSpark(3));
        } else {
    ...
    public Command getAutonomousCommand() {
        return new PrintCommand("Auto not configured");
    }

    public Command getTeleopCommand() {
        return new PrintCommand("Teleop not configured");
    }
}